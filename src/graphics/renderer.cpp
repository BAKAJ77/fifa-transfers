...
void Renderer::Init(WindowFramePtr window)
{
	...
	const float squareVertexData[] = { -0.5f, -0.5f, 0.5f, -0.5f, 0.5f,  0.5f, -0.5f, 0.5f };
	const float triangleVertexData[] = { -0.5f, -0.5f, 0.5f, -0.5f, 0.0f,  0.5f };
	...
	this->squareGeometryVao->PushLayout(0, 2, 2 * sizeof(float));
