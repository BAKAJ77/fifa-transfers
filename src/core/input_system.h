...
// Mouse codes extracted from the GLFW 3 source code.
...
public:
	...
	InputSystem(InputSystem&& temp) noexcept = delete;
	~InputSystem() = default;

	InputSystem& operator=(const InputSystem& other) = delete;
	InputSystem& operator=(InputSystem&& temp) noexcept = delete;
	...
	// Note that if you pass a orthogonal camera object, then the cursor position is mapped to the camera viewport resolution 
